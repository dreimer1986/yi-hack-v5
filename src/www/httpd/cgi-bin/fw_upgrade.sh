...
if [ "$VAL" == "info" ] ; then
    ...
    PRERELEASE_FW=`wget -O - https://api.github.com/repos/pawelma/yi-hack-v5-slim/releases 2>&1 | grep -B 4 '"prerelease": true' | awk -F '"' '{print $4; exit}'`
...
#        mv /tmp/sd/${MODEL_SUFFIX}_x.x.x.tgz /tmp/sd/${MODEL_SUFFIX}/${MODEL_SUFFIX}_x.x.x.tgz
        ...
        wget https://github.com/pawelma/yi-hack-v5-slim/releases/download/$LATEST_FW/${MODEL_SUFFIX}_${LATEST_FW}.tgz
...
#        mv /tmp/sd/${MODEL_SUFFIX}_x.x.x.tgz /tmp/sd/${MODEL_SUFFIX}/${MODEL_SUFFIX}_x.x.x.tgz
        ...
        wget https://github.com/pawelma/yi-hack-v5-slim/releases/download/$PRERELEASE_FW/${MODEL_SUFFIX}_${PRERELEASE_FW}.tgz
